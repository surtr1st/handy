  ...
  <NSpace vertical>
    <NLayout has-sider style="height: 100vh">
      <NLayoutSider bordered collapse-mode="width" :collapsed-width="64" :width="240" :collapsed="collapsed"
        ...
        <NMenu :icon-size="30" v-model:value="activeKey" :collapsed="collapsed" :collapsed-width="64"
          :collapsed-icon-size="22" :options="menuOptions" />
      </NLayoutSider>
      <NLayout :native-scrollbar="false" content-style="padding: 1rem;" style="display: grid; place-items: center">
        <RouterView />
      </NLayout>
    </NLayout>
  </NSpace>
